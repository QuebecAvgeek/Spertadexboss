...
async def rarity(self, interaction: discord.Interaction):
    ...
    for collectible in sorted_collectibles:
        ...
        rarity_text = rarity_mapping.get(collectible.rarity, "Not Found")
        entry = (name, f"{emote} Rarity: {rarity_text}")
    ...
    source.embed.colour = discord.Colour.from_rgb(168, 199, 247)
